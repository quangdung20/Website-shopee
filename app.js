...
function hoverSp1(type){
    ...
    if (type){
        imageSp.src = "../image/item1-sp6.jpg";
    }else{
        imageSp.src = "../image/item1-sp1.jpg";
    }
}
...
function hoverSp2(type){
    ...
    if (type){
        imageSp.src = "../image/item1-sp4.jpg";
    }else{
        imageSp.src = "../image/item1-sp2.jpg";
    }
}
...
function hoverSp3(type){
    ...
    if (type){
        imageSp.src = "../image/item1-sp7.jpg";
    }else{
        imageSp.src = "../image/item1-sp3.jpg";
    }
}
...
function hoverSp5(type){
    ...
    if (type){
        ...
        imageSp.src = "../image/item1-sp5.jpg";
    }
}
...
function hoverSp6(type){
    ...
    if (type){
        imageSp.src = "../image/item1-sp8.jpg";
    }else{
        imageSp.src = "../image/item1-sp6.jpg";
    }
}
